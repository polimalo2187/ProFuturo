...
async def mensajes(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message.text:
        ...
        try:
            ...
            # Captura el error exacto y se lo enviamos al usuario
            error_msg = f"⚠️ Ocurrió un error al procesar tu mensaje:\n{e}"
            logger.error(f"Error generando respuesta para {user_id}: {e}", exc_info=True)
